...
2. Copy Folder "Linnstrument" to your Ableton User Libary / Remote Scripts
3. On Linnstrument: Left Split: CC-Fader (1-8), 1 Row
4. Open Ableton
5. Ableton Preferences, Remote Scripts, choose "Linnstrument" and "Linnstrument Midi" for Input / Output
6. Switch betwenn "Note Mode" and "Session Mode" with Pad 8, Row 1 on your Linnstrument
...
![Session Mode]([http://url/to/img.png](https://github.com/SamplixBeatz/LinnStrument_Ableton-Remote-Script/blob/main/pictures/01_Session Mode.JPG))
